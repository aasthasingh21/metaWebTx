            ...
            <div className="w-4xl min-h-screen text-black py-5 flex flex-col items-center justify-center">
                <div className="flex flex-col items-center gap-5 px-5">
                    <form className="w-full" onSubmit={handleSubmit}>
                        ...
                        <button className="w-full bg-blue-500 px-5 py-4 rounded-md mt-2" type="submit" value="Make New Account">Login</button>
                    </form>
                    <span>Don't have an account ? <a href="/login" className="text-blue-500">Register</a></span>
                </div>
            </div>
        </div>
    ) 
